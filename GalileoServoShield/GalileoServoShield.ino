...
//  bool doEnd = true;
  ...
  pulselength0 = map(startDegree, 0, 180, SERVOMIN, SERVOMAX);
  pwm.setPWM(0, 0, pulselength0);
  pulselength1 = map(startDegree, 0, 180, SERVOMIN, SERVOMAX);
  pwm.setPWM(1, 0, pulselength1);
  pulselength2 = map(startDegree, 0, 180, SERVOMIN, SERVOMAX);
  pwm.setPWM(2, 0, pulselength2);
  pulselength3 = map(startDegree, 0, 180, SERVOMIN, SERVOMAX);
  pwm.setPWM(3, 0, pulselength3);
  pulselength4 = map(startDegree, 0, 180, SERVOMIN, SERVOMAX);
  pwm.setPWM(4, 0, pulselength4);
  pulselength5 = map(startDegree, 0, 180, SERVOMIN, SERVOMAX);
  pwm.setPWM(5, 0, pulselength5);
  pulselength6 = map(startDegree, 0, 180, SERVOMIN, SERVOMAX);
  pwm.setPWM(6, 0, pulselength6);
  pulselength7 = map(startDegree, 0, 180, SERVOMIN, SERVOMAX);
